...
export default function AdminHome() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Vendor */}
      <TouchableOpacity onPress={VedoropenModal} style={styles.headerItem}>
        <View style={styles.locationContainer}>
          <Text style={styles.locationText}>{selectedVendor}</Text>
          <FeatherIcon name="chevron-down" size={20} color="#007bff" style={styles.locationArrow}/>
        </View>
      </TouchableOpacity>
        ...
        <View style={styles.userCircle}>
         ...
         {userData.companyName ? userData.companyName.charAt(0).toUpperCase() : ''}
       </Text>}
       </View>
        </TouchableOpacity>
...
<Modal
  ...
  onRequestClose={VendorcloseModal}
>
  <View style={styles.centeredView}>
    <View style={styles.modalView}>
      <Text style={styles.modalText}>Select Vendor</Text>
