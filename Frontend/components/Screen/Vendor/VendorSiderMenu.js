...
export default function VendorSiderMenu() {
    ...
    const fetchUserData = useCallback(async () => {
      try {
        ...
        const response = await axios.get(`http://192.168.0.107:3000/api/vendor/vendor/${vendorId}`);  // Fetch user details using user ID
...
>
        ...
        <ScrollView>
          <View style={styles.section}>
            ...
            <TouchableOpacity
                    onPress={() => navigation.navigate('ManageFoodCollection')}
              style={styles.row}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.rowLabel}>View Orders</Text>
